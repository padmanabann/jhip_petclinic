package com.mahakavi.jpetclinic.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("jhip_petclinic");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("jhip_petclinic");
        ...
        config.getMapConfigs().put("com.mahakavi.jpetclinic.domain.*", initializeDomainMapConfig(jHipsterProperties));
